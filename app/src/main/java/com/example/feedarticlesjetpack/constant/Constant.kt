...
const val STATUS_NEW_ARTICLE_SUCCESS = 1
const val STATUS_NEW_ARTICLE_FAILURE = 0
const val STATUS_NEW_ARTICLE_PARAM_PROBLEM = -1
const val STATUS_NEW_ARTICLE_UNAUTHORIZED = 5
