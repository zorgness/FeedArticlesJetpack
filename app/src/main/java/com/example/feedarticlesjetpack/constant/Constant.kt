...
const val STATUS_MUTATION_ARTICLE_SUCCESS = 1
const val STATUS_MUTATION_ARTICLE_FAILURE = 0
const val STATUS_MUTATION_ARTICLE_ID_PROBLEM = 2
const val STATUS_MUTATION_ARTICLE_PARAM_PROBLEM = -1
const val STATUS_MUTATION_ARTICLE_UNAUTHORIZED = 5
